            ...
            <div class="col-md-12">
                <div class="shadow-sm card rounded-3">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.content.blog.update', $blog) }}">
                            @csrf
                            @method('put')
                            <!-- Name -->
                            <div class="mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="body" name="body" placeholder="body ..." rows="5" required autofocus>{{ old('body', $blog->body) }}</textarea>
                            </div>
